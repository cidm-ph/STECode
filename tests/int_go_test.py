...
@pytest.mark.parametrize(
    ...
    [
        ("test1_eaesubtype.tab",
            ...
            "test1",
            False,
            {'#Sequence_ID': ['test1'], 'eae_sub': ['06'], 'iso_tox': ['00'], 'tox1': ['1A'], 'tox2': ['2C'], 'tox3': ['00'], 'tox4': ['00'], 'Virulence_barcode': ['06-00-1A-2C-00-00']}),
        ("test2_eaesubtype.tab",
            "test2_2recAstxeae.txt",
            "test2_sfindAbricate.tab",
            "test2",
            False,
            {'#Sequence_ID': ['test2'], 'eae_sub': ['03'], 'iso_tox': ['00'], 'tox1': ['1A'], 'tox2': ['00'], 'tox3': ['00'], 'tox4': ['00'], 'Virulence_barcode': ['03-00-1A-00-00-00']})
    ]
)
